...
function SignUpFormContent({ errorParam, redirectToParam }: SignUpFormProps) {
  ...
  useEffect(() => {
    // Fires immediately when the signup card mounts to wake up sleeping Render free-tier containers
  ...
  // Direct-to-Google OAuth Flow Handler (Bypasses Render screen flashes)
